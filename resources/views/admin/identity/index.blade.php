		...
		<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
    				<!--begin::Page Title-->
    				<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">身份列表</h5>
    				<!--end::Page Title-->
    				<!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="javascript:;" class="text-muted">身份列表</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
			...
			<div class="card card-custom">
				<div class="card-header border-0 py-3">
					<div class="card-title">
						...
						<h3 class="card-label">身份列表</h3>
					</div>
					<div class="card-toolbar">
                        @can ('identity/create', $method::GET)
    						<!--begin::Button-->
    						<a href="{{ url('identity/create') }}" class="btn btn-primary font-weight-bolder">
                                <i class="la la-plus"></i>添加身份
                            </a>
    						<!--end::Button-->
                        @endcan
					</div>
                ...
                <div class="card-body pt-0 pb-3">
                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                            ...
                            <tbody>
                                @php
                                    $edit = verifyAccess('identity/*/edit', $method::GET);
                                    $delete = verifyAccess('identity/*', $method::DELETE);
                                @endphp
                                @foreach ($identities as $identity)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($edit)
                                                <a href="{{ url('identity/' . $identity->id . '/edit') }}" class="btn btn-sm btn-clean btn-icon mr-2" title="编辑数据">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                            @endif
                                            @if ($delete)
                                                <a href="{{ url('identity/' . $identity->id) }}" class="btn btn-sm btn-clean btn-icon mr-2 destroy" title="删除数据">
                    ...
                    <div class="d-flex justify-content-end">
                        {{ $identities->appends($request->query())->links() }}
                    </div>
                </div>
			</div>
			<!--end::Card-->
