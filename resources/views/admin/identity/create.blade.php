		...
		<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
    				<!--begin::Page Title-->
    				<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">添加身份</h5>
    				<!--end::Page Title-->
    				<!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="javascript:;" class="text-muted">添加身份</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
		...
		<div class="container">
            ...
            <div class="card card-custom">
                <div class="card-header py-3">
                    <h3 class="card-title">添加身份</h3>
                </div>
                <form class="form" method="post" action="{{ url('identity') }}">
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-form-label text-lg-right col-lg-3"><span class="text-danger">*</span> 身份名称</label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="name" placeholder="请输入身份名称"/>
                            </div>
                        </div>
                        <div class="form-group row">
