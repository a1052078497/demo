		...
		<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
    				<!--begin::Page Title-->
    				<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">编辑管理员</h5>
    				<!--end::Page Title-->
    				<!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="javascript:;" class="text-muted">编辑管理员</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
	...
	<div class="d-flex flex-column-fluid">
		...
		<div class="container">
            ...
            <div class="card card-custom">
                ...
                <form class="form" method="post" action="{{ url('admin/' . $admin->id) }}">
                    <div class="card-body">
                                ...
                                <select class="form-control" name="identity_id">
                                    ...
                                    @foreach ($identities as $identity)
                                        <option value="{{ $identity->id }}"
                                            @if ($identity->id == $admin->identity_id) selected="" @endif
                                        >
                                            {{ $identity->name }}
                                        </option>
                                    @endforeach
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="username" placeholder="请输入用户名" value="{{ $admin->username }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label text-lg-right col-lg-3">密码</label>
                            <div class="col-lg-8">
                                <input type="password" class="form-control password" name="password" placeholder="如需要修改密码请输入">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label text-lg-right col-lg-3">确认密码</label>
                            <div class="col-lg-8">
                                <input type="password" class="form-control" name="password_confirmation" placeholder="需与上方一致">
                            </div>
                        </div>
                    </div>
