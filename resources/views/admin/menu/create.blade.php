		...
		<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
    				<!--begin::Page Title-->
    				<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">添加菜单</h5>
    				<!--end::Page Title-->
    				<!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="javascript:;" class="text-muted">添加菜单</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
	...
	<div class="d-flex flex-column-fluid">
		...
		<div class="container">
            ...
            <div class="card card-custom">
                ...
                <form class="form" method="post" action="{{ url('menu') }}">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="icon" placeholder="点击选择" readonly="readonly">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label text-lg-right col-lg-3"><span class="text-danger">*</span> 菜单路由</label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="route" placeholder="路由参数用*表示"/>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                            	<div class="radio-inline">
	                                <label class="radio radio-outline radio-success">
										<input type="radio" name="is_verify" value="1" checked="">
										<span></span>是
									</label>
									<label class="radio radio-outline radio-success">
										<input type="radio" name="is_verify" value="0">
										<span></span>否
									</label>
								</div>
                            </div>
